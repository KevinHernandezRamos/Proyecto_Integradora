...
class DashboardApp:
    ...
    def crear_elementos(self):
        ...
        ctk.CTkFrame(self.main_frame, height=2, fg_color="#3B82F6").pack(fill="x", pady=15) # Separador visual

        action_btn_frame = ctk.CTkFrame(self.main_frame, fg_color="transparent")
